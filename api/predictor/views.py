...
class IndexView(ListView):
    template_name= 'babycry/index.html' #template for babycry
...
def model_form_upload(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            context = {'genre':genre}
            return render(request,'babycry/result.html',context)  # result page of babycry
    else:
        form = DocumentForm()

    return render(request,'babycry/result.html',{'documents':documents,'form':form})